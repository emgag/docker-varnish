...
* [`7.1.1` (*7.1.1/Dockerfile*)](https://github.com/emgag/docker-varnish/blob/master/7.1/Dockerfile), based on debian:bullseye-slim.
  * linux/amd64
  * linux/arm64 (see notes)
* [`7.0.3` (*7.0.3/Dockerfile*)](https://github.com/emgag/docker-varnish/blob/master/7.0/Dockerfile), based on debian:bullseye-slim.
  * linux/amd64
  * linux/arm64 (see notes)
...
```
FROM ghcr.io/emgag/varnish:7.1.1
...
services:
  varnish:
    image: ghcr.io/emgag/varnish:7.1.1
    volumes:
      - ./varnish:/etc/varnish
    ports:
      - "80:80"
