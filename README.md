...
* [`7.7.0` (*7.7.0/Dockerfile*)](https://github.com/emgag/docker-varnish/blob/master/7.5/Dockerfile), based on debian:bookworm-slim.
  * linux/amd64
  * linux/arm64
* [`7.6.2` (*7.6.0/Dockerfile*)](https://github.com/emgag/docker-varnish/blob/master/7.5/Dockerfile), based on debian:bookworm-slim.
  * linux/amd64
  * linux/arm64
...
* **Only 7.7, 7.6 and 6.0** are [versions supported by varnish](https://varnish-cache.org/releases/index.html) and maintained in this repo.
...
```
FROM ghcr.io/emgag/varnish:7.7.0
...
services:
  varnish:
    image: ghcr.io/emgag/varnish:7.7.0
    volumes:
      - ./varnish:/etc/varnish
    ports:
      - "80:80"
